...
/**
 *
 * Class FasterPay_FasterPay_Block_Checkout_Form_Method_Abstract
 */
class FasterPay_FasterPay_Block_Checkout_Form_Method_Abstract extends Mage_Payment_Block_Form
{
    private $modelName;
    ...
    public function getPaymentModel()
    {
        if (!$this->paymentModel) {
            $this->paymentModel = Mage::getModel('fasterpay/method_' . $this->modelName);
        }
